...
![Spatial patterns in Sea Surface Temperature](images/GeographeAMP_SST.png){#fig-spatialsst}
...
ADD FIGURE - temporal patterns in habitats - shallow

ADD FIGURE - temporal patterns in habitats - mesophotic
...
![Temporal predictions for the shallow ecosystem depth contour (0 - 30 m) of key fish metrics for the `{r} marine_park`.](images/GeographeAMP_shallow_control-plots.png){#fig-temppreds}

![Temporal predictions for the mesophotic ecosystem depth contour (30 - 70 m) of key fish metrics for the `{r} marine_park`.](images/GeographeAMP_mesophotic_control-plots.png)
