...
habi <- readRDS(paste0("data/", park, "/tidy/", name, "_benthos-count.RDS")) %>%
 ...
 #  dplyr::filter(geoscience_roughness < 4) %>% # TODO Filter outliers - check and adjust AL removed for abrolhos
  glimpse()
...
# Macroalgae - two competitive models
