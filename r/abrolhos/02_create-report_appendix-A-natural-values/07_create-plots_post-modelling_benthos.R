...
# TODO Plot extent
prediction_limits <- c(112, 115.4, -30, -27)
...
# -------------------------------------------------------------------
dir.create(paste0("plots/", park, "/habitat/"), recursive = TRUE, showWarnings = FALSE) # AL added this
for (yr in years) {
...
site_limits <- c(112, 115.4, -30, -27) # TODO set limits
