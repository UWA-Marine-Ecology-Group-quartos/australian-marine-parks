...
# Set plot inputs
plot_limits <- c(112, 115.4, -30, -27) # TODO Extent of the main plot
study_limits <- c(112, 115.4, -30, -27) # TODO Extent of sampling
...
metadata <- readRDS(paste0("data/", park, "/tidy/", name, "_metadata-bathymetry-derivatives.rds")) %>%
  ...
  glimpse()
# Set plot inputs
site_limits <- c(112, 115.4, -30, -27) # TODO Plot limits for subsequent plots - tighter zoom
# Create plot
