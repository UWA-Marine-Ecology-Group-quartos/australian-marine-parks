...
# status removed throughout - no No-Take samples in ERMP
# total_abundance & b20: no year term supported by FSS, so per-year predictions
# for those two metrics will be identical

# Total abundance: detrended + reef (no year supported by FSS)
...
# Species richness: roughness + reef + year
...
# B20: detrended + reef (no year supported by FSS)
