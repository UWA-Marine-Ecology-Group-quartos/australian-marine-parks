...
tidy_maxn <- readRDS(paste0("data/", park, "/tidy/", name, "_tidy-count.rds")) %>% # AL removed outlier removal
...
# Total abundance - best: geoscience_roughness + reef (no year in FSSgam but keep for BACI)
...
# Species richness - best: reef only
...
# CTI - best: geoscience_detrended + reef + year
...
# B20 - best: geoscience_depth + reef
